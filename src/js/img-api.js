...
// `${BASE_URL}?key=${KEY_API}&q=cat&image_type=photo&orientation=horizontal&safesearch=true`
...
//     return axios.get(`${BASE_URL}?key=${KEY_API}&q=cat&image_type=photo&orientation=horizontal&safesearch=true`).then(response => {
